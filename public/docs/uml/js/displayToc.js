      ...
      for (var j = 0; parTree.length > j; j++) {
        ...
        if (
          ...
          tmpCurToc[tmpCurToc.length - 4].src
            .substring(
              tmpCurToc[tmpCurToc.length - 4].src.lastIndexOf("uml/images")
            )
            .indexOf("plus") != -1
        ) {
...
function tocBuild(data) {
  ...
  if (tocLastID != 0) {
    ...
    tocLastSrc.src = tocLastSrc.src
      .substring(tocLastSrc.src.lastIndexOf("uml/images"))
      .replace("01", "02");
  }
}
  ...
  if (tocTab[i][0] != 0 || tocTab[i][1] == 3) {
          ...
          document
            ...
            .parentNode.childNodes[m].src.substring(
              document
                ...
                .parentNode.childNodes[m].src.lastIndexOf("uml/images")
            )
            .indexOf("02") != -1 ||
          document
            .getElementById(
    ...
    if (tocTab[i][1] == 3) {
      tocImage.src = tocImage.src
        .substring(tocImage.src.lastIndexOf("uml/images"))
        .replace("01", "02");
      if (tocImage.parentNode.parentNode.childNodes.length > 1) {
        ...
        tocTmp.src = tocTmp.src
          .substring(tocTmp.src.lastIndexOf("uml/images"))
          .replace("02", "01");
      }
    }
    ...
    if (tocTab[i][1] && tocTab[i][1] != 3) {
      ...
      if (
        ...
        tocTmpSrc.src = tocTmpSrc.src
          .substring(tocTmpSrc.src.lastIndexOf("uml/images"))
          .replace("02", "01");
      }
...
function tocClick(tocSrc) {
  if (
    tocSrc.src
      .substring(tocSrc.src.lastIndexOf("uml/images"))
      .indexOf("minus") != -1
  ) {
  ...
  if (ele && ele.style.display == "none") {
    ...
    cont.document.getElementById(idImage).src =
      cont.document
        ...
        .src.substring(
          0,
          cont.document.getElementById(idImage).src.lastIndexOf("uml/images")
        ) +
      "images" +
      cont.document
        .getElementById(idImage)
...
function toggleData(src) {
  ...
  if (
    cont.document
      .getElementById(src)
      .src.substring(
        cont.document.getElementById(src).src.lastIndexOf("uml/images")
      )
      .indexOf("plus") != -1
  )
    cont.document.getElementById(src).src =
      ...
      cont.document
        .getElementById(src)
        .src.substring(
          cont.document.getElementById(src).src.lastIndexOf("umuml/imagesl")
        )
        .replace("plus", "minus");
  else
    cont.document.getElementById(src).src =
